  ...
  return (
    <div className="mx-auto max-w-5xl px-6">
      <section className="border-b border-[var(--hairline)] py-20">
        ...
        <h1 className="mt-4 max-w-2xl text-4xl font-medium leading-tight tracking-tight text-[var(--ink-primary)] sm:text-5xl">
          Algorithms, from <span className="text-[var(--accent)]">first principles</span>.
        </h1>
      ...
      {categories.map((category) => (
        <section key={category.name} className="py-12">
          <div className="flex items-baseline justify-between gap-4 border-b border-[var(--hairline)] pb-4">
            ...
            <p className="text-right text-[13px] text-[var(--ink-muted)]">
