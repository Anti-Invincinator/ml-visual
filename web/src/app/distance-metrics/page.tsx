  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12">
      ...
      <section className="mt-16">
        <h2 className="text-xl font-medium text-[var(--ink-primary)]">Unit balls</h2>
      ...
      <section className="mt-20 border-t border-[var(--hairline)] pt-16">
        <h2 className="text-xl font-medium text-[var(--ink-primary)]">Two points, four metrics</h2>
        <p className="mt-1 text-[15px] text-[var(--ink-secondary)]">
      ...
      <section className="mt-20 border-t border-[var(--hairline)] pt-16">
        <h2 className="text-xl font-medium text-[var(--ink-primary)]">When the data isn&apos;t round</h2>
        <p className="mt-1 max-w-2xl text-[15px] text-[var(--ink-secondary)]">
